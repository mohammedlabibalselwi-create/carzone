...
class _AccountScreenState extends State<AccountScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildProfileHeaderCard(isArabic, isDark),
            ...
            _buildSectionHeader(
              title: _t(isArabic, 'إدارة الحساب والمركبات', 'Account & Vehicles'),
              isDark: isDark,
            ),
            ...
            _buildMenuGroup(
              ...
              items: [
                _buildMenuItem(
                  ...
                  title: _t(isArabic, 'تعديل البيانات الشخصية', 'Edit Profile Data'),
                  subtitle: _t(isArabic, 'الاسم، رقم الهاتف، والبريد', 'Name, phone & email'),
                  isDark: isDark,
                  onTap: () => _showSnackBar(_t(isArabic, 'تعديل الملف الشخصي', 'Edit Profile')),
                ),
                _buildMenuItem(
                  icon: Icons.directions_car_filled_outlined,
                  title: _t(isArabic, 'مركباتي المسجلة (2)', 'My Registered Vehicles (2)'),
                  subtitle: _t(isArabic, 'تويوتا كامري، هيونداي تكسون', 'Toyota Camry, Hyundai Tucson'),
                  isDark: isDark,
                  onTap: () => _showSnackBar(_t(isArabic, 'إدارة المركبات', 'Manage Vehicles')),
                ),
                _buildMenuItem(
                  icon: Icons.location_on_outlined,
                  title: _t(isArabic, 'العناوين المحفوظة', 'Saved Addresses'),
                  subtitle: _t(isArabic, 'المنزل، العمل، وموقع الصيانة', 'Home, Work & Garage'),
                  isDark: isDark,
                  onTap: () => _showSnackBar(_t(isArabic, 'العناوين المحفوظة', 'Saved Addresses')),
                ),
                _buildMenuItem(
                  icon: Icons.payment_rounded,
                  title: _t(isArabic, 'طرق الدفع والبطاقات', 'Payment Methods'),
                  subtitle: _t(isArabic, 'بطاقات الماستركارد والمحفظة', 'Cards & Wallet'),
                  isDark: isDark,
                  showDivider: false,
                  onTap: () => _showSnackBar(_t(isArabic, 'طرق الدفع', 'Payment Methods')),
                ),
              ],
            ),
            ...
            _buildMenuGroup(
              ...
              items: [
                _buildMenuItem(
                  ...
                  title: _t(isArabic, 'مركز المساعدة والدعم الفني', 'Help & Support Center'),
                  subtitle: _t(isArabic, 'الأسئلة الشائعة والتواصل معنا', 'FAQ & Live Chat'),
                  isDark: isDark,
                ...
                _buildMenuItem(
                  ...
                  subtitle: _t(isArabic, 'عن منصة CarZone للخدمات', 'About CarZone Platform'),
                  isDark: isDark,
                  onTap: () => _showAboutUsDialog(isArabic, isDark),
                ),
                _buildMenuItem(
                  icon: Icons.privacy_tip_outlined,
                  title: _t(isArabic, 'شروط الخدمة وسياسة الخصوصية', 'Terms & Privacy Policy'),
                  subtitle: _t(isArabic, 'حقوق الاستخدام والأمان', 'Terms of service & privacy'),
                  isDark: isDark,
                ...
                _buildMenuItem(
                  ...
                  subtitle: _t(isArabic, 'شاركونا رأيكم على المتجر', 'Rate us on Store'),
                  isDark: isDark,
                  showDivider: false,
                  onTap: () => _showSnackBar(_t(isArabic, 'شكراً لتقييمك التطبيق!', 'Thank you for rating!')),
                ),
              ],
            ),
            ...
            _buildAuthButton(isArabic, isDark),

            const SizedBox(height: 16),

            // App Version Footer
            Text(
              _t(isArabic, 'إصدار التطبيق CarZone v1.2.0 (أحدث إصدار)', 'CarZone App Version v1.2.0'),
              style: GoogleFonts.cairo(
                fontSize: 12,
  ...
  Widget _buildProfileHeaderCard(bool isArabic, bool isDark) {
    return Container(
  ...
  Widget _buildAuthButton(bool isArabic, bool isDark) {
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        ...
        icon: const Icon(Icons.login_rounded, color: AppPalette.primary),
        label: Text(
          _t(isArabic, 'تسجيل الدخول أو التبديل لحساب آخر', 'Sign In or Switch Account'),
          style: GoogleFonts.cairo(
            fontSize: 14.5,
            fontWeight: FontWeight.bold,
            color: AppPalette.primary,
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            ListTile(
              leading: const Icon(Icons.phone_in_talk_rounded, color: AppPalette.primary),
              title: Text(_t(isArabic, 'الاتصال الهاتفي المباشر', 'Direct Call'), style: GoogleFonts.cairo(fontWeight: FontWeight.bold)),
              subtitle: Text('+967 800 000 00', style: GoogleFonts.cairo(fontSize: 12)),
              onTap: () => Navigator.pop(ctx),
            ),
            ListTile(
              leading: const Icon(Icons.chat_bubble_outline_rounded, color: AppPalette.accent),
              title: Text(_t(isArabic, 'المحادثة الفورية (WhatsApp)', 'WhatsApp Support'), style: GoogleFonts.cairo(fontWeight: FontWeight.bold)),
              subtitle: Text(_t(isArabic, 'رد فوري خلال دقائق', 'Instant response'), style: GoogleFonts.cairo(fontSize: 12)),
              onTap: () => Navigator.pop(ctx),
            ),
          ],
        ),
