      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMenuGroup(
              ...
              children: [
                _buildThemeSelectorTile(
                  ...
                  subtitle: _t(isArabic, 'ألوان فاتحة ومريحة للعين في النهار', 'Comfortable light appearance'),
                ...
                _buildThemeSelectorTile(
                  ...
                  subtitle: _t(isArabic, 'مظهر داكن وموفر للطاقة والبطارية', 'Dark sleek appearance'),
            ...
            _buildSectionHeader(
              title: _t(isArabic, 'إعدادات الإشعارات', 'Notifications Settings'),
            ...
            _buildMenuGroup(
              ...
              children: [
                _buildSwitchTile(
                  title: _t(isArabic, 'إشعارات الصيانة والمواعيد', 'Maintenance & Appointments'),
                  subtitle: _t(isArabic, 'تذكير قبل موعد الصيانة الدورية', 'Reminders before service date'),
                ...
                Divider(height: 1, indent: 60, color: cardBorder(isDark)),
                _buildSwitchTile(
                  title: _t(isArabic, 'تنبيهات حالة الطلبات', 'Order Status Updates'),
                  subtitle: _t(isArabic, 'إشعار مباشر عند تحديث حالة الطلب', 'Live updates on order progress'),
                ...
                Divider(height: 1, indent: 60, color: cardBorder(isDark)),
                _buildSwitchTile(
                  title: _t(isArabic, 'عروض وتخفيضات CarZone', 'Promotions & Discounts'),
                  subtitle: _t(isArabic, 'إرسال التخفيضات والكوبونات', 'Receive coupons & discount alerts'),
            ...
            _buildMenuGroup(
              ...
              children: [
                _buildClickableTile(
                  ...
                  subtitle: _t(isArabic, 'تحديث كلمة المرور الخاصة بحسابك', 'Update account password'),
                  icon: Icons.lock_reset_rounded,
                  isDark: isDark,
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(_t(isArabic, 'الانتقال لصفحة استعادة كلمة المرور', 'Navigating to password reset'), style: GoogleFonts.cairo()),
                        backgroundColor: AppPalette.primary,
                      ),
                    );
                  },
                ...
                Divider(height: 1, indent: 60, color: cardBorder(isDark)),
                _buildSwitchTile(
                  title: _t(isArabic, 'الدخول بالبصمة / FaceID', 'Biometric / FaceID Login'),
                  subtitle: _t(isArabic, 'تسجيل دخول سريع وآمن بالبصمة', 'Quick fingerprint & face login'),
            ...
            _buildMenuGroup(
              ...
              children: [
                _buildClickableTile(
                  title: _t(isArabic, 'مسح الذاكرة المؤقتة (Cache)', 'Clear App Cache'),
                  subtitle: _t(isArabic, 'تحرير المساحة وتسريع التطبيق (14.2 ميجابايت)', 'Free space & speed up app (14.2 MB)'),
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(_t(isArabic, 'تم مسح الذاكرة المؤقتة بنجاح', 'Cache cleared successfully'), style: GoogleFonts.cairo()),
